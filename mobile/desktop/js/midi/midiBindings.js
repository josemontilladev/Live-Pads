  ...
  engine.initMIDI(msg => {
    ...
    if (mapping) {
      ...
      if (data2 > 0) {
        ...
        } else if (mapping.action === 'toggle_metronome') {
          // Import dinámico para no acoplar el módulo MIDI al metrónomo.
          import('../ui/metronomeModal.js')
            .then(m => m.isMetronomeModalOpen() ? m.closeMetronomeModal() : m.openMetronomeModal())
            .catch(() => {});
